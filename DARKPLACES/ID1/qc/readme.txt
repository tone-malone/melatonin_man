...
What's Included
---------------
array.txt : brief description of frikqcc 2.6 arrays
readme.txt : this file
manual.txt : JP Grossman's qccx manual.
gnu.txt : GNU General Public License
frikgui.exe : Frikqcc 2.7 with new graphical interface
frikdec.exe : FrikQcc's Decompiler, Win32 console
...
FrikQCC homepage at http://wiki.quakesrc.org
